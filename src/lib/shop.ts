...
export const SHOP_ITEMS: ShopItem[] = [
  // -- BASICS ---------------------------------------------------------------
  { id: "basic-tee-moss",   name: "Moss Tee",       slot: "top",      price: 0,   emoji: "👕", color: "#5b8a3a", set: "basic", description: "A soft cotton tee the color of fresh moss." },
  { id: "basic-tee-bloom",  name: "Bloom Tee",      slot: "top",      price: 0,   emoji: "👕", color: "#d97a8a", set: "basic", description: "A warm pink tee for sunny mornings." },
  ...
  { id: "basic-jeans",      name: "Walking Jeans",  slot: "bottom",   price: 0,   emoji: "👖", color: "#3a4f78", set: "basic", description: "Tough denim that survives bramble paths." },
  ...
  { id: "basic-sneakers",   name: "Soft Sneakers",  slot: "shoes",    price: 0,   emoji: "👟", color: "#dcdcdc", set: "basic", description: "For a gentler kind of expedition." },
  ...
  { id: "basic-crop-blush", name: "Blush Crop Top",  slot: "top",      price: 45,  emoji: "👚", color: "#e889a8", set: "basic", description: "A cute cropped tee with soft sleeves." },
  { id: "basic-tank-sky",   name: "Sky Tank Top",    slot: "top",      price: 35,  emoji: "🎽", color: "#69a7d8", set: "basic", description: "Simple, bright, and easy to layer." },
  { id: "basic-longsleeve", name: "Long Sleeve Top", slot: "top",      price: 55,  emoji: "👕", color: "#8a6fd8", set: "basic", description: "A neat long-sleeve top for cooler days." },
  { id: "basic-pleat-skirt",name: "Pleated Skirt",   slot: "bottom",   price: 45,  emoji: "👗", color: "#d86f9b", set: "basic", description: "A soft little skirt that twirls nicely." },
  { id: "basic-denim-skirt",name: "Denim Skirt",     slot: "bottom",   price: 50,  emoji: "👗", color: "#4b6f9f", set: "basic", description: "A classic denim skirt for everyday outfits." },
  { id: "basic-leggings",   name: "Cozy Leggings",   slot: "bottom",   price: 40,  emoji: "👖", color: "#343044", set: "basic", description: "Soft leggings for running around." },
  { id: "basic-slippers",   name: "Cloud Slippers",  slot: "shoes",    price: 30,  emoji: "🩴", color: "#f0b6c8", set: "basic", description: "Comfy slippers with a soft rounded shape." },
  { id: "basic-maryjanes",  name: "Mary Janes",      slot: "shoes",    price: 50,  emoji: "👞", color: "#2f2a34", set: "basic", description: "Neat little shoes for dressy outfits." },
  { id: "basic-canvas-high",name: "High Sneakers",   slot: "shoes",    price: 60,  emoji: "👟", color: "#f2f2f2", set: "basic", description: "Chunky high-top sneakers." },
  { id: "basic-pinafore",   name: "Pinafore Dress",  slot: "dress",    price: 0,   emoji: "👗", color: "#e8a0b8", set: "basic", description: "A simple cute dress with a soft skirt." },
  { id: "basic-party-dress",name: "Party Dress",     slot: "dress",    price: 90,  emoji: "👗", color: "#b98cf0", set: "basic", description: "A puffy little dress for celebrations." },
  ...
  { id: "basic-scarf",      name: "Cozy Scarf",     slot: "accessory", price: 0,  emoji: "🧣", overlayEmoji: "🧣", set: "basic", description: "For brisk dawn walks." },
  { id: "basic-glasses",    name: "Round Glasses",  slot: "accessory", price: 0,  emoji: "👓", overlayEmoji: "👓", set: "basic", description: "Spot the smallest insects." },
  ...
  { id: "basic-compass",    name: "Brass Compass",  slot: "accessory", price: 0,  emoji: "🧭", overlayEmoji: "🧭", set: "basic", description: "Always points home — eventually." },
  ...
  { id: "clover-dress",     name: "Sunshine Smock",  slot: "dress",   price: 110, emoji: "👗", color: "#e0c75a", set: "clover", description: "The color of a four-leaf-clover wish." },
  ...
  { id: "prem-dress-princess", name: "Princess Gown",    slot: "dress",     price: 360, emoji: "👗", color: "#c78cf2", set: "premium", description: "A full princess gown with a sparkly skirt." },
  { id: "prem-dress-rose",     name: "Rose Ballgown",   slot: "dress",     price: 340, emoji: "👗", color: "#e874a2", set: "premium", description: "A rounded rose-pink ballgown." },
  { id: "prem-dress-tutu",     name: "Ribbon Tutu",     slot: "dress",     price: 260, emoji: "👗", color: "#f0a8d8", set: "premium", description: "A layered tutu dress with a ribbon waist." },
  { id: "prem-shoes-sparkle",  name: "Sparkle Sneakers",slot: "shoes",     price: 170, emoji: "👟", color: "#d8d8f0", set: "premium", description: "Sneakers with tiny star shine." },
  { id: "prem-shoes-bow",      name: "Bow Sandals",     slot: "shoes",     price: 150, emoji: "🩴", color: "#e8a0b8", set: "premium", description: "Soft sandals with little bows." },
