...
export const QUEST_INTROS: Record<string, Partial<Record<string, string>>> = {
  ...
  // ── Window / Observer quests ───────────────────────────────────────────
  "Spot a cloud that looks like an animal": {
    willow: "The sky paints riddles, even through glass. Read me one.",
    "professor-hoot": "Pareidolia from indoors. Sketch the suspect cloud.",
    pip: "Sky zoo through the window! What's prowling up there?!",
    mossback: "Watch slow. The right cloud always drifts by.",
    clover: "Oh please let it be a bunny! Or a duckling!",
  },
  "Find an interesting shadow indoors or out": {
    willow: "Shadows are the world's quiet drawings. Find a good one.",
    "professor-hoot": "Document a shadow with character. Note the source.",
    pip: "Shadow safari! Long ones, wobbly ones — go!",
    mossback: "A curtain on a sunny floor. Hard to beat.",
    clover: "Shadow puppets without trying! How fun!",
  },
  "Spot a bird from your window": {
    willow: "A feathered visitor at your pane. Greet it kindly.",
    "professor-hoot": "Window-frame ornithology. Note plumage and posture.",
    pip: "Window bird! Don't tap the glass — just LOOK!",
    mossback: "They land where they please. Patience helps.",
    clover: "A little winged hello! Wave back, gently!",
  },
  "Find the closest tree you can see": {
    willow: "Pick your nearest leafy neighbour. Learn its shape.",
    "professor-hoot": "Identify the closest arboreal specimen in view.",
    pip: "Closest tree challenge! Spot it spot it spot it!",
    mossback: "A good tree to know. Visit it often, even by eye.",
    clover: "Your window-tree friend! Give it a name!",
  },
  "Watch something move in the wind": {
    willow: "Let the wind show you what it's carrying today.",
    "professor-hoot": "Aeolian motion study. Leaf, flag, or laundry — pick one.",
    pip: "Wiggle watch! Find the wiggliest thing!",
    mossback: "A slow sway is a fine sermon.",
    clover: "Like the world is dancing for you!",
  },
  "Find a sunbeam in your room": {
    willow: "A patch of light is a tiny spell. Step into it.",
    "professor-hoot": "Indoor insolation event. Note the angle.",
    pip: "Sun puddle! Stand right in it!",
    mossback: "Warm floor, warm soul.",
    clover: "A golden little square just for you!",
  },
  "Spot a raindrop, dew, or condensation": {
    willow: "Tiny waters. Each one a small mirror.",
    "professor-hoot": "Hydrologic micro-observation. Window glass works nicely.",
    pip: "Dewy droplet! Race them down the glass!",
    mossback: "A drop on a leaf is the whole pond, really.",
    clover: "Like the window is wearing jewellery!",
  },
  "Pick a small detail outside your window": {
    willow: "Let your eye land on something most people miss.",
    "professor-hoot": "Micro-detail isolation exercise. One feature only.",
    pip: "Tiny detail! Smaller! Smaller! There!",
    mossback: "A single tile. A single brick. Plenty.",
    clover: "A teeny treasure hiding in plain sight!",
  },
  "Find the moon (day or night)": {
    willow: "She's about, somewhere. Wave when you find her.",
    "professor-hoot": "Lunar localisation. Note phase and altitude.",
    pip: "Moon hunt! Day moons are sneaky!",
    mossback: "She visits in her own time. Always worth the wait.",
    clover: "Hi moon! Glad you're up there!",
  },
  "Find three colors in the view from your window": {
    willow: "Three colours, three little spells. Speak them aloud.",
    "professor-hoot": "Chromatic survey. Three distinct hues, please.",
    pip: "Color count! One, two, three — go go go!",
    mossback: "Even a grey day has more colours than you think.",
    clover: "A little rainbow right outside your room!",
  },
  "Spot any animal — bird, pet, insect, person walking a dog": {
    willow: "Any creature counts. We're all kin, after all.",
    "professor-hoot": "Fauna sighting, broadly defined. Document the species.",
    pip: "ANY animal! Even a sleepy cat counts!",
    mossback: "Slow lookers see more. Try not to blink.",
    clover: "A friend! Of any size! How wonderful!",
  },
  "Watch a single leaf for one minute": {
    willow: "One leaf, one minute. A tiny meditation.",
    "professor-hoot": "Sustained micro-observation. Sixty seconds. Begin.",
    pip: "A whole minute on ONE leaf?! Okay, okay…",
    mossback: "Now you're speaking my language.",
    clover: "You'll see it twitch and dance, I promise!",
  },
  "Find a perfect right-angle in nature outside": {
    willow: "Nature prefers curves. A right angle is a small miracle.",
    "professor-hoot": "Rectilinear geometry in the wild. Rare. Document it.",
    pip: "Right-angle hunt! Trickier than it sounds!",
    mossback: "I've seen one. Once. Unforgettable.",
    clover: "A little square corner in the wild — magic!",
  },
  "Spot something blue from where you are": {
    willow: "Blue hides indoors too. Cushion, cup, or cover — find one.",
    "professor-hoot": "Locate a blue object within reach. Sky disqualified.",
    pip: "Blue thing! NOT the sky! NOT the sky!",
    mossback: "Look low. Blue lives in the small things.",
    clover: "A little blue surprise — hooray!",
  },
  "Notice the quality of the light right now": {
    willow: "Light tells the hour better than any clock. What does it say?",
    "professor-hoot": "Subjective luminance assessment. Warm? Cool? Soft?",
    pip: "Light check! Bright? Glowy? Moody? Quick!",
    mossback: "Light at dusk is the kindest light.",
    clover: "Like the room is wearing its best outfit!",
  },
  "Listen for three different sounds from outside": {
    willow: "Three sounds, three small spells. Gather them softly.",
    "professor-hoot": "Acoustic transect. Three distinct sources, please.",
    pip: "Ears up! Three sounds! No repeats!",
    mossback: "Open the window a crack. The world will tell you everything.",
    clover: "A little outside symphony just for you!",
  },
  "Find the closest plant to you": {
    willow: "Your nearest green friend. Say a quiet hello.",
    "professor-hoot": "Identify the proximate flora. Houseplant counts.",
    pip: "Closest plant! Found it found it found it!",
    mossback: "Plants like company. Even just looking.",
    clover: "Give it a tiny compliment from me!",
  },
  "Frame a tiny scene like a postcard": {
    willow: "Make a frame with your fingers. There — your postcard.",
    "professor-hoot": "Compositional exercise. Borders matter as much as subject.",
    pip: "Postcard pose! Snap it with your eyes!",
    mossback: "A small view, well-held. That's the trick.",
    clover: "A keepsake just for your memory!",
  },
  "Find a reflection somewhere": {
    willow: "Mirrors hide everywhere. Find one that surprises you.",
    "professor-hoot": "Locate a reflective surface. Note what it doubles.",
    pip: "Reflection hunt! Sneaky mirror found!",
    mossback: "A puddle, a screen — even a spoon will do.",
    clover: "Two of everything! What a treat!",
  },
  "Watch a bird in flight (or imagine one)": {
    willow: "Follow the wings, even if only in your mind.",
    "professor-hoot": "Avian flight observation. Glide vs flap, please.",
    pip: "Fly bird fly! Track it from corner to corner!",
    mossback: "Up there is fast. Down here is deep. Both are good.",
    clover: "Imagine the breeze under those little wings!",
  },
};
