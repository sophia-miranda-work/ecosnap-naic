  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Sticky live preview */}
        <div className="flex shrink-0 items-center justify-center border-b border-border bg-gradient-to-b from-primary/10 to-transparent py-2">
          <DressupAvatar dressup={dressup} size={156} />
        </div>
